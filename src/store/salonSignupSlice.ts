...
// imageurl , first name , lastname , email , phone number , position
type newStaff =
...
const salonSlice = createSlice({
  ...
  reducers: {
    ...
    // Update step6 (staff)
    updateStep7(state, action: PayloadAction<stylistSignupType["step7"]>) {
...
// Export actions
export const salonSliceActions = salonSlice.actions;
