...
const Step6 = () => {
  ...
  let step6Data = useAppSelector((state) => state.signupSalon.step6);
  let [isOpen, setIsOpen] = useState(false);
  const formHandler = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault();

    dispatch(salonSliceActions.updateStep6(step6Data));
    dispatch(salonSliceActions.setCurrentStep(7));
  };
      ...
      <div className="bg-gren-500 flex justify-evenly items-center w-6/12">
        <div className="flex justify-center bg-ellow-500 flex-auto">
          <Button
            ...
            onClick={() => {
              dispatch(salonSliceActions.setCurrentStep(5));
            }}
          >
            <IoArrowBack />
          </Button>
          ...
          <DialogDescription>
            ...
            <Button
              ...
              onClick={() => {
                ...
                dispatch(salonSliceActions.updateStep6(newState));
