...
const Step5 = () => {
  ...
  let step5Data = useAppSelector((state) => state.signupStylist.step5);
  ...
  const formHandler = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    dispatch(stylistSliceActions.updateStep5(step5));
    dispatch(stylistSliceActions.setCurrentStep(6));
  };
      ...
      <div className="bg-gren-500 flex justify-evenly items-center w-6/12">
        <div className="flex justify-center bg-ellow-500 flex-auto">
          <Button
            ...
            onClick={() => {
              dispatch(stylistSliceActions.updateStep5(step5));
              dispatch(stylistSliceActions.setCurrentStep(4));
            }}
          >
            <IoArrowBack />
          </Button>
